...
module.exports = function(client) {
  ...
  return {
      ...
      seen: function(from, channel, message) {
        ...
        if (user) {
          if (user.joined === null && user.left === null) {
            client.say(
              channel,
              message + ' is here! I have no idea when he/she came though :('
            );
            ...
            if (user.left !== null && user.joined < user.left) {
              ...
              client.say(
                channel,
                message + ' is here! He/She came ' + ago(user.joined) + '!'
              );
            }
            ...
            client.say(
              channel,
              "Something's wrong with me. Fix meeeh, fix meeeee :(((("
            );
            process.exit(1);
          }
        } else {
    ...
    help: {
      seen:
        'Returns the last time the specified user was seen in this channel. Usage: !seen USER',
    },
  };
};
